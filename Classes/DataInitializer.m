...
-(void) InitializeDB:(NSManagedObjectContext *) objectContext
{
	...
	evento.descripcion = @"El constante desarrollo e innovación en materia de videojuegos, se debe en gran medida, a la tecnología en la que se apoya. ¿Quieres saber cómo han evolucionado los gráficos en los videojuegos? Descubre en esta conferencia, la historia, la situación actual en el país y tips para entrar al negocio de la computación gráfica.";
	evento.ponente = @"Marcel Stockli Contreras, Alberto Ramírez Valadez";
    evento.ponenteDesc = @"Marcel Stockli Contreras. Co- fundador de GameCoder, seleccionado nacional en informática en el 2007 y 2008. Forma parte del equipo representante de arte de México en las mundiales de programación del 2011. Actualmente es programador en GameCoder y estudiante de ciencias de la computación en la UG/CIMAT con computación gráfica como la área principal de trabajo. Alberto Ramírez Valadez. Estudiante en Lic. en ciencias de la computación en la Universidad de Guanajuato. Ganador de medallas en concursos de programación a nivel nacional. Seleccionado para representado a México internacionalmente en concursos relacionados con la programación. Y co-fundador de GameCoder S.R.L. De C.V., empresa en el desarrollo de juegos e investigación en computación gráfica.";
	evento.agendado = false;
